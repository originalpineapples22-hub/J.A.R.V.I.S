...
DEFAULTS = {
    ...
    "use_ollama": True,                # your own PC as a brain — detected automatically when running
    "prefer_local": True,              # your hardware first; the cloud pool is backup, not the foundation
